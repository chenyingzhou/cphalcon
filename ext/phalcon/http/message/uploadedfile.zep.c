...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, moveTo) {
	...
	_6 = _5;
	if (_6) {
		ZEPHIR_CALL_FUNCTION(&_7, "dirname", NULL, 321, targetPath);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_8, "is_dir", NULL, 124, &_7);
		zephir_check_call_status();
		_6 = zephir_is_true(&_8);
	}
	_9 = _6;
	if (_9) {
		ZEPHIR_CALL_FUNCTION(&_10, "dirname", NULL, 321, targetPath);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_11, "is_writable", NULL, 322, &_10);
		zephir_check_call_status();
	...
	if (UNEXPECTED(_16)) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "storefile", NULL, 323, targetPath);
		zephir_check_call_status();
	} else {
		zephir_read_property(&_17$$7, this_ptr, SL("fileName"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_18$$7, "move_uploaded_file", NULL, 324, &_17$$7, targetPath);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkError) {
	...
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 8);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_number_ce, "between", &_1, 283, &_2, &_3, &_4);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, storeFile) {
	...
	ZEPHIR_CALL_METHOD(&stream, this_ptr, "getstream", NULL, 325);
	zephir_check_call_status();
