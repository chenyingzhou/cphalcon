...
PHP_METHOD(Phalcon_Http_Message_Uri, __construct) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &uri))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "filterfragment", NULL, 326, &_2$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_10$$3, this_ptr, "filterpath", NULL, 327, &_11$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_12$$3, this_ptr, "filterport", NULL, 328, &_13$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_15$$3, this_ptr, "filterquery", NULL, 329, &_16$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_17$$3, this_ptr, "filterscheme", NULL, 330, &_18$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, __toString) {
	...
	ZEPHIR_CALL_METHOD(&authority, this_ptr, "getauthority", NULL, 331);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_8);
	ZVAL_STRING(&_8, ":");
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "checkvalue", NULL, 332, &_0, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "//");
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "checkvalue", NULL, 332, &authority, &_7);
	zephir_check_call_status();
	zephir_read_property(&_11, this_ptr, SL("query"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "?");
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "checkvalue", NULL, 332, &_11, &_7);
	zephir_check_call_status();
	zephir_read_property(&_13, this_ptr, SL("fragment"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "#");
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "checkvalue", NULL, 332, &_13, &_7);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&uri);
...
PHP_METHOD(Phalcon_Http_Message_Uri, getAuthority) {
	...
	ZEPHIR_CALL_METHOD(&userInfo, this_ptr, "getuserinfo", NULL, 333);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "");
...
PHP_METHOD(Phalcon_Http_Message_Uri, withFragment) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "filterfragment", NULL, 326, fragment);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPath) {
	...
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "filterpath", NULL, 327, path);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPort) {
	...
	if (UNEXPECTED(Z_TYPE_P(port) != IS_NULL)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "filterport", NULL, 328, port);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withQuery) {
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "filterquery", NULL, 329, query);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withScheme) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "filterscheme", NULL, 330, scheme);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(scheme, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "scheme");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 334, scheme, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withHost) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "host");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 334, host, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterQuery) {
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _5, _6, _3)
		{
			...
			ZVAL_COPY(&part, _3);
			ZEPHIR_CALL_METHOD(&split, this_ptr, "splitqueryvalue", &_7, 335, &part);
			zephir_check_call_status();
