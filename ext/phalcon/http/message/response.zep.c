...
PHP_METHOD(Phalcon_Http_Message_Response, __construct) {
	...
	ZVAL_LONG(&_0, code);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processcode", NULL, 282, &_0);
...
PHP_METHOD(Phalcon_Http_Message_Response, processCode) {
	...
	ZEPHIR_CALL_METHOD(&phrases, this_ptr, "getphrases", NULL, 284);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkcodetype", NULL, 285, code);
	zephir_check_call_status();
	_0 = zephir_get_intval(code);
	ZEPHIR_INIT_NVAR(code);
	ZVAL_LONG(code, _0);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkcodevalue", NULL, 286, code);
	zephir_check_call_status();
