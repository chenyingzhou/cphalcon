...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, createServerRequest) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 290, &method, uri, &serverParams);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, load) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "checknullarray", NULL, 291, &server, &globalServer);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&server, &_0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "checknullarray", NULL, 291, &files, &globalFiles);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&files, &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checknullarray", NULL, 291, &cookies, &globalCookies);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&cookies, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "checknullarray", NULL, 291, &get, &globalGet);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&get, &_3);
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "checknullarray", NULL, 291, &post, &globalPost);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&post, &_4);
	ZEPHIR_CALL_METHOD(&serverCollection, this_ptr, "parseserver", NULL, 292, &server);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_5);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&protocol, this_ptr, "parseprotocol", NULL, 293, &serverCollection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&headers, this_ptr, "parseheaders", NULL, 294, &serverCollection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&filesCollection, this_ptr, "parseuploadedfiles", NULL, 295, &files);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_7)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&cookiesCollection, this_ptr, "parsecookieheader", NULL, 296, &_9$$8);
		zephir_check_call_status();
	}
	object_init_ex(return_value, phalcon_http_message_serverrequest_ce);
	ZEPHIR_CALL_METHOD(&_11, this_ptr, "parseuri", NULL, 297, &serverCollection, &headers);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 290, &method, &_11, &_12, &_5, &_13, &cookiesCollection, &get, &_14, &post, &protocol);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, getHeaders) {
	...
	if (EXPECTED((zephir_function_exists_ex(ZEND_STRL("apache_request_headers")) == SUCCESS))) {
		ZEPHIR_RETURN_CALL_FUNCTION("apache_request_headers", NULL, 298);
		zephir_check_call_status();
		RETURN_MM();
	}
	RETURN_MM_BOOL(0);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, calculateUriHost) {
	...
	ZVAL_STRING(&_0, "host");
	ZVAL_BOOL(&_2, 0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getheader", NULL, 299, headers, &_0, &_2);
	zephir_check_call_status();
	if (UNEXPECTED(zephir_is_true(&_1))) {
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "host");
		ZEPHIR_CALL_METHOD(&host, this_ptr, "getheader", NULL, 299, headers, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "calculateurihostfromheader", NULL, 300, &host);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, calculateUriPath) {
	...
	if (UNEXPECTED(Z_TYPE_P(&requestUri) != IS_NULL)) {
		...
		ZVAL_STRING(&_6$$4, "");
		ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 48, &_5$$4, &_6$$4, &requestUri);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, calculateUriScheme) {
	...
	ZEPHIR_CALL_METHOD(&header, this_ptr, "getheader", NULL, 299, headers, &_1, &_8);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, createUploadedFile) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 301, &_4, &_5, &_6, &name, &type);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseCookieHeader) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 302, &_1, &cookies);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseHeaders) {
	...
	ZEPHIR_CALL_METHOD(NULL, &headers, "__construct", NULL, 21);
	zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&serverArray), _2, _3, _0)
		{
			...
			if (EXPECTED(!ZEPHIR_IS_IDENTICAL(&_4$$3, &value))) {
				...
				if (EXPECTED(ZEPHIR_IS_LONG_IDENTICAL(&_12$$4, 0))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &headers, "set", &_18, 41, &name, &value);
					zephir_check_call_status();
					continue;
				}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseProtocol) {
	...
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_1, "http/")) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_7$$4, "__construct", NULL, 39, &_8$$4);
		zephir_check_call_status();
	...
	if (UNEXPECTED(!(zephir_array_isset(&protocols, &localProtocol)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$5, "__construct", NULL, 39, &_12$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseServer) {
	...
	ZEPHIR_CALL_METHOD(NULL, &collection, "__construct", NULL, 21, &server);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&headers, this_ptr, "getheaders", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "HTTP_AUTHORIZATION");
	ZEPHIR_CALL_METHOD(&_0, &collection, "has", NULL, 303, &_1);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_2)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &headersCollection, "__construct", NULL, 21, &headers);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "Authorization");
		ZEPHIR_CALL_METHOD(&_3$$3, &headersCollection, "has", NULL, 303, &_4$$3);
		zephir_check_call_status();
		if (UNEXPECTED(zephir_is_true(&_3$$3))) {
			ZEPHIR_INIT_VAR(&_6$$4);
			ZVAL_STRING(&_6$$4, "Authorization");
			ZEPHIR_CALL_METHOD(&_5$$4, &headersCollection, "get", NULL, 304, &_6$$4);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_6$$4);
			ZVAL_STRING(&_6$$4, "HTTP_AUTHORIZATION");
			ZEPHIR_CALL_METHOD(NULL, &collection, "set", NULL, 41, &_6$$4, &_5$$4);
			zephir_check_call_status();
		}
	}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseUploadedFiles) {
	...
	if (Z_TYPE_P(&files) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&files), _2, _3, _0)
		{
			...
			if (UNEXPECTED(_5$$3)) {
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 41, &key, &file);
				zephir_check_call_status();
				continue;
			}
			...
			if (EXPECTED(_7$$3)) {
				ZEPHIR_CALL_METHOD(&_8$$5, this_ptr, "createuploadedfile", &_9, 305, &file);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 41, &key, &_8$$5);
				zephir_check_call_status();
				continue;
			}
			if (UNEXPECTED(Z_TYPE_P(&file) == IS_ARRAY)) {
				ZEPHIR_CALL_METHOD(&data, this_ptr, "parseuploadedfiles", &_10, 295, &file);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_11$$6, &data, "toarray", &_12, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 41, &key, &_11$$6);
				zephir_check_call_status();
				continue;
			}
		} ZEND_HASH_FOREACH_END();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (EXPECTED(_15$$7)) {
					ZEPHIR_CALL_METHOD(&_16$$9, this_ptr, "createuploadedfile", &_9, 305, &file);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 41, &key, &_16$$9);
					zephir_check_call_status();
					continue;
				}
				if (UNEXPECTED(Z_TYPE_P(&file) == IS_ARRAY)) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 41, &key, &_17$$10);
					zephir_check_call_status();
					continue;
				}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseUri) {
	...
	ZEPHIR_CALL_METHOD(NULL, &uri, "__construct", NULL, 102);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&scheme, this_ptr, "calculateurischeme", NULL, 306, server, headers);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &uri, "withscheme", NULL, 307, &scheme);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&uri, &_0);
	ZEPHIR_CALL_METHOD(&split, this_ptr, "calculateurihost", NULL, 308, server, headers);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&_1);
	...
	if (EXPECTED(!(ZEPHIR_IS_EMPTY(&_1)))) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, &uri, "withhost", NULL, 309, &_3$$3);
		zephir_check_call_status();
		...
		if (UNEXPECTED(!(ZEPHIR_IS_EMPTY(&_4$$3)))) {
			...
			ZEPHIR_CALL_METHOD(&_5$$4, &uri, "withport", NULL, 310, &_6$$4);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&uri, &_5$$4);
		}
	}
	ZEPHIR_CALL_METHOD(&path, this_ptr, "calculateuripath", NULL, 311, server);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_0, &uri, "withpath", NULL, 312, &_8);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&uri, &_0);
	if (UNEXPECTED(zephir_fast_count_int(&split) > 1)) {
		...
		ZEPHIR_CALL_METHOD(&_9$$5, &uri, "withfragment", NULL, 313, &_10$$5);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&uri, &_9$$5);
	}
	ZEPHIR_CALL_METHOD(&query, this_ptr, "calculateuriquery", NULL, 314, server);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &uri, "withquery", NULL, 315, &query);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&uri, &_0);
	RETURN_CCTOR(&uri);
