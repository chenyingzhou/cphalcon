	...
	if (Z_TYPE_P(&_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_1), _4, _5, _2)
		{
			...
			if (Z_TYPE_P(&value) != IS_NULL) {
				...
				ZEPHIR_CALL_FUNCTION(NULL, "header", &_7, 358, &_6$$5, &__$true);
				zephir_check_call_status();
			} else {
				...
				if (_8$$6) {
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_7, 358, &header, &__$true);
					zephir_check_call_status();
				} else {
					ZEPHIR_INIT_NVAR(&_12$$8);
					ZEPHIR_CONCAT_VS(&_12$$8, &header, ": ");
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_7, 358, &_12$$8, &__$true);
					zephir_check_call_status();
				}
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&value) != IS_NULL) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_7, 358, &_13$$10, &__$true);
					zephir_check_call_status();
				} else {
					...
					if (_14$$11) {
						...
						ZEPHIR_CALL_FUNCTION(NULL, "header", &_7, 358, &_18$$13, &__$true);
						zephir_check_call_status();
					}
				}
