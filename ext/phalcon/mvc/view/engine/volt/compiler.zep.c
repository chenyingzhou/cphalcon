...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileCache) {
	...
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "statementlist", NULL, 503, &_13, &_14);
	zephir_check_call_status();
	...
	while (1) {
		...
		do {
			...
			if (ZEPHIR_IS_LONG(&type, 366)) {
				...
				ZEPHIR_CALL_METHOD(&_22$$72, this_ptr, "expression", &_7, 501, &_23$$72);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&exprCode);
			...
			ZEPHIR_CALL_METHOD(NULL, &_24$$76, "__construct", &_28, 502, &_27$$76);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, functionCall) {
	...
	ZEPHIR_CALL_METHOD(&_14, this_ptr, "expression", NULL, 501, &nameExpr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveFilter) {
	...
	if (zephir_array_isset_string_fetch(&funcArguments, &filter, SL("arguments"), 0)) {
		if (!ZEPHIR_IS_STRING(&name, "default")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 507, &funcArguments, &_4$$7);
	...
	if (Z_TYPE_P(&statements) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&statements), _2)
		{
			...
			do {
				...
				ZEPHIR_CALL_METHOD(NULL, &_59$$38, "__construct", &_8, 502, &_62$$38);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_string(&statement, SL("type"))))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_63$$41, "__construct", &_8, 502, &_66$$41, &statement);
					zephir_check_call_status();
				...
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_11, 504, &_68$$42, &_67$$42);
					zephir_check_call_status();
					if (Z_TYPE_P(&tempCompilation) == IS_STRING) {
						zephir_concat_self(&compilation, &tempCompilation);
						continue;
				...
				do {
					...
					if (ZEPHIR_IS_LONG(&type, 307)) {
						...
						if (zephir_is_true(&blockMode)) {
							...
							if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
								...
								ZEPHIR_CALL_METHOD(&_83$$58, this_ptr, "statementlist", &_35, 503, &blockStatements, &_84$$58);
								zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(NULL, &_99$$72, "__construct", &_8, 502, &_102$$72);
					zephir_check_call_status();
