	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			if (Z_TYPE_P(&_50$$3) != IS_NULL) {
				...
				ZVAL_STRING(&_53$$38, "");
				ZEPHIR_CALL_FUNCTION(&_54$$38, "preg_replace", &_55, 48, &_52$$38, &_53$$38, &_51$$38);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_57$$38, "strcasecmp", &_58, 46, &_56$$38, &_52$$38);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &_59$$3, "__construct", &_60, 189, &columnName, &definition);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_STRING(&_105$$40, "NO")) {
					zephir_array_update_string(&definition, SL("notNull"), &__$true, PH_COPY | PH_SEPARATE);
				}
				...
				if (Z_TYPE_P(&_107$$40) != IS_NULL) {
					...
					ZVAL_STRING(&_110$$75, "");
					ZEPHIR_CALL_FUNCTION(&_111$$75, "preg_replace", &_55, 48, &_109$$75, &_110$$75, &_108$$75);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_113$$75, "strcasecmp", &_58, 46, &_112$$75, &_109$$75);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_114$$40, "__construct", &_60, 189, &columnName, &definition);
				zephir_check_call_status();
